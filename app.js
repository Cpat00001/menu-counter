  ...
  return{
    storeItem: function (item){
      ...
      if(localStorage.getItem('items')=== null){
        ...
        items.push(item);
        // set and save into localStorage
        localStorage.setItem('items', JSON.stringify(items));
      }else{
        //get item which are already in localStorage
    ...
    //Update item in local storage after clicked update button
    updateItemStorage:function(updatedItem){
      let items = JSON.parse(localStorage.getItem('items'));

    //loop throught the items in localStorage
...
const ItemCtrl = (function(){
  ...
  //update item after submit update button
...
const UICtrl = (function(){
  ...
  return{
    ...
    //update UI insert changed item name or calories
    updateListItem: function(item){
      let listItems = document.querySelectorAll(UISelectors.listItems);

      //turn node list into arra
      updateListItems = Array.from(listItems);

      //loop through array listItems
      updateListItems.forEach(function(listItem){
    ...
    //remove item after clickkin button "clear all"
...
const App = (function (ItemCtrl, StorageCtrl, UICtrl) {
  ...
  return{
    init: function(){
      ...
      //Clear init state / Set initial state /Call a function to hide buttons delete, edit, back
      UICtrl.clearEditState();
